    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0f0f10] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">ZapOne</h1>
          <p className="text-[#71717a] text-sm mt-1">Central de Atendimento WhatsApp</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-[#18181b] border border-[#27272a] rounded-lg text-white placeholder-[#52525b] focus:outline-none focus:border-[#25d366] focus:ring-1 focus:ring-[#25d366] transition-colors"
              required
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-[#25d366] hover:bg-[#1da851] disabled:opacity-50 text-white font-semibold rounded-lg transition-colors"
          >
